...
**1.** Copy the `SpruceChat` folder to `/mnt/SDCARD/App/` on your SD card.

**2.** Grab the model (~409MB):

```
https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct-GGUF/resolve/main/qwen2.5-0.5b-instruct-q4_0.gguf
```

Drop it in `SpruceChat/models/`.

**3.** Launch from the Apps menu. First boot takes about a minute while the model loads. After that, it's ready to chat.
